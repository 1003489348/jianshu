			...
			<div class="layui-row chat">
				...
				<div class="layui-col-md8 chat_item">
					...
					<div class="layui-row lib">
						<div class="layui-col-md1"><img src="../../assets/388e473c-fe2f-40e0-9301-e357ae8f1b41.jpeg" alt=""></div>
		...
		<div class="layui-hide-sm">
			...
			<div class="layui-row chat1">
				...
				<div class="layui-col-md8 chat_item">
					...
					<div class="layui-row" style="height: 20px;"></div>
					<div class="layui-row lib">
						<div class="layui-col-md1 layui-col-xs2"><img src="../../assets/388e473c-fe2f-40e0-9301-e357ae8f1b41.jpeg" alt=""></div>
					...
					<div class="layui-row lib">
						<div class="layui-col-md1 layui-col-xs2"><img src="../../assets/hangju.webp" alt=""></div>
						<div class="layui-col-md8 layui-col-xs9 left">
							<p>光头强</p>
							<span>欢迎加入撒大大阿斯顿阿三打算大苏打撒法发啊</span>
						</div>
