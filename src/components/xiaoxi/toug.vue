			...
			<div class="layui-row chat">
				...
				<div class="layui-col-md8 chat_item">
					...
					<div class="layui-row lib">
						<div class="layui-col-md1"><img src="../../assets/7314c5cc-ca7f-4542-b914-2c8dffaf324d.jpg" alt=""></div>
		...
		<div class="layui-hide-sm">
			...
			<div class="layui-row chat1">
				...
				<div class="layui-col-md8 chat_item">
					...
					<div class="layui-row" style="height: 20px;"></div>
					<div class="layui-row lib">
						<div class="layui-col-md1 layui-col-xs2"><img src="../../assets/7314c5cc-ca7f-4542-b914-2c8dffaf324d.jpg" alt=""></div>
